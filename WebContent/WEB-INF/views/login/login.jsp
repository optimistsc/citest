...
<div id="contents">
	...
	<tr><td width="60"></td><td width="390" height="180">
	...
	<tr><td colspan="2" height="125"><center><input type="image" border="0" src="${pageContext.request.contextPath}/resources/img/login_btn.png"><br/><br/>
