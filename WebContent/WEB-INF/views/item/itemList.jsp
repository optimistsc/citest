...
// 상품 라인 클릭 시 상품수정으로 이동하는 jQuery
$().ready(
		function(){
			$("tr#bolist > td").not(":first").hover(function(){
				$(this).click(function(){window.location.href=$("tr#bolist").find("a").attr("href");
				});
			});
		});
...
<c:forEach var="itemDto" items="${itemList }">
	<tbody>
		<tr id="bolist">
		<td><input type="checkbox" value="${itemDto.opt_code }"></td>
		<td><img src="${itemDto.s_picture }" width="78.75px" height="102.5px"></td>
		<td><b>${itemDto.opt_code }</b></td>
