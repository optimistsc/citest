...
function dongcheck(){
	if(document.getElementById("dong").value == "") {
		...
		document.zipform.action = "${pageContext.request.contextPath}/zipsearch1.do";
		document.zipform.submit();
	}
}

function selectzip(z1, z2, address){	
	opener.document.shipInfoForm.zip1.value = z1;
	opener.document.shipInfoForm.zip2.value = z2;
	opener.document.shipInfoForm.addr1.value = address;
